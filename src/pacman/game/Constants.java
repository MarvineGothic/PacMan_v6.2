...
public final class Constants {
    ...
    public static final int DELAY = 30;                        //delay (in milliseconds) between game advancements
    ...
    //for Maze
    public static final String PATH_MAZES = "data/mazes";
    public static final String PATH_DISTANCES = "data/distances";
    public static final String[] NODE_NAMES = {"a", "b", "c", "d"};
    public static final String[] DIST_NAMES = {"da", "db", "dc", "dd"};
    //for GameView
    public static final int MAG = 2;
    public static final int GV_WIDTH = 114;
    public static final int GV_HEIGHT = 130;
    public static final String PATH_IMAGES = "data/images";
    public static final String[] MAZE_NAMES = {"maze-a.png", "maze-b.png", "maze-c.png", "maze-d.png"};
