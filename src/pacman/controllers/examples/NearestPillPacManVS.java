...
import static pacman.controllers.examples.NearestPillPacMan.nearestTargets;
...
public final class NearestPillPacManVS extends Controller<MOVE> {
    ...
    public MOVE getMove(Game game, long timeDue) {
        ...
        int nearest = game.getClosestNodeIndexFromNodeIndex(currentNodeIndex, nearestTargets(game), DM.PATH);
...
//		if(game.getGhostLairTime(GHOST.BLINKY)==0 && activePowerPills.length>0)
//			GameView.addPoints(game,Color.WHITE,game.getShortestPath(game.getGhostCurrentNodeIndex(GHOST.BLINKY),
...
//		for(GHOST ghostType : GHOST.values())
//			if(game.getGhostLairTime(ghostType)==0)
//				GameView.addPoints(game,colors[index++],game.getShortestPath(game.getGhostCurrentNodeIndex(ghostType),currentNodeIndex,game.getGhostLastMoveMade(ghostType)));
